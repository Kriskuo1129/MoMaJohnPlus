...
目前可執行版本已完成 Phase 1-A～1-D：玩家每局先從三張正式場中事件選一張並選擇槓桿，按下「開牌局」後才 Commit、扣除局數，依 committed config 進行 14／15／16 張正式摸牌。Item 機率權重與免洗護身符的完整局中事件整合留待 Phase 1-E；Mini-game Skeleton 仍屬 Phase 2。
