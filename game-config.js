...
const PRE_ROUND_EVENT_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({ id: "seven-set", title: "字齊七七", description: "正式取得七萬、七筒、七條。", type: "BET", effectKey: "REQUIRE_TILES", tileIds: ["wan-7", "tong-7", "suo-7"], reward: 15, penalty: 10 }),
  Object.freeze({ id: "compass", title: "指南針是你？", description: "正式取得東、南、西、北。", type: "BET", effectKey: "REQUIRE_TILES", tileIds: ["east", "south", "west", "north"], reward: 15, penalty: 10 }),
  Object.freeze({ id: "ever-waiting", title: "我一定聽牌", description: "本局至少一次進入聽牌。", type: "BET", effectKey: "EVER_WAITED", reward: 5, penalty: 5 }),
  Object.freeze({ id: "complete-line", title: "我一定連線", description: "本局至少完成 1 條正式連線。", type: "BET", effectKey: "MIN_LINES", minimum: 1, reward: 15, penalty: 5 }),
  Object.freeze({ id: "stop-at-waiting", title: "點到為止", description: "至少一條曾聽牌的線最終未完成。", type: "BET", effectKey: "UNFINISHED_WAITING_LINE", reward: 5, penalty: 5 }),
  Object.freeze({ id: "rock-paper-scissors", title: "與老闆猜拳", description: "勝：特殊倍率 ×2；敗：×0.5；平手重猜。", type: "SPECIAL", effectKey: "ROCK_PAPER_SCISSORS" }),
  Object.freeze({ id: "boss-boost", title: "老闆加碼", description: "本局特殊倍率 ×2。", type: "SPECIAL", effectKey: "SPECIAL_MULTIPLIER", multiplier: 2 }),
